  ...
  return (
    <nav className="absolute top-0 left-0 w-full z-20 bg-transparent">
      <div className="flex items-center justify-between mx-auto px-[10%] py-10">
        ...
        <button
          onClick={toggleMenu}
          className="md:hidden text-darkGray text-base font-medium z-40 focus:outline-none"
        >
      ...
      {/* Mobile Dropdown */}
      {isMenuOpen && (
        <div className="absolute top-0 left-0 w-full h-screen bg-white z-30 md:hidden">
          <Menu />
        </div>
      )}
    </nav>
